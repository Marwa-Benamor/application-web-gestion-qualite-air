        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Je me connecte en tant que gestionnaire</h5>
                            <?php
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if ($email === "admin@gmail.com" && $password === "AZERTY") {
                            ...
                            <form action="" method="post">
                                <div class="mb-3">
                                    <label for="email" class="form-label">Mon identifiant</label>
